...
# create the FastAPI instance and mount the static frontend
# serve files from the "static" directory; index.html will be returned at root
# create the FastAPI instance
app = FastAPI(title="GPT Model API", version="1.0.0")
# mount the static directory under /static so assets can be referenced if needed
app.mount("/static", StaticFiles(directory="static"), name="static")

# CORS: allow requests from frontend hosts. Use a restrictive list in production.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
async def generate(request: GenerateRequest):
    ...
    try:
        ...
        # Encode prompt
        prompt_tokens = enc.encode(request.prompt)
